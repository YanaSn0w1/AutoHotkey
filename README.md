...
Right click + down scroll for 'j' (X/Twitter next post) 

Right click + up scroll for Ctrl + Enter 
...
Same thing as [Mouse Hotkeys.ahk](https://github.com/YanaSn0w1/AutoHotkey/blob/main/Mouse%20Hotkeys.ahk "Mouse Hotkeys.ahk") ⬅️ but more advanced, hold right + scroll up generates an AI reply with [Quote_beast.py](https://github.com/YanaSn0w1/Python/blob/main/Quotebeast/Quote_beast.py "Quote_beast.py") ⬅️
